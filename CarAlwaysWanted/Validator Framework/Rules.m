...
+ (Rule *)checkIfEqual:(NSString *)failureString forTextField:(UITextField *)textField withtextfield:(UITextField *)textfield1 {
    Rule *resultRule = [[Rule alloc] init];
    resultRule.failureMessage = failureString;
    resultRule.textField = textField;
    resultRule.textField1 = textfield1;
    resultRule.isValid = [NSString isNotEqualToString:textField.text withstring:textfield1.text];
    return resultRule;
}

+(Rule *)checkIfnotblankWithFailureString:(NSString *)failureString forTextField:(UITextField *)textField {
    Rule *resultRule = [[Rule alloc] init];
    resultRule.failureMessage = failureString;
    resultRule.textField = textField;
    resultRule.isValid = [NSString checkIfBlank:textField.text];
    return resultRule;
}

+(Rule *)checkIffirstdigitWithFailureString:(NSString *)failureString forTextField:(UITextField *)textField {
    Rule *resultRule = [[Rule alloc] init];
    resultRule.failureMessage = failureString;
    resultRule.textField = textField;
    resultRule.isValid = [NSString checkIffirstDigit:textField.text];
    return resultRule;
}
